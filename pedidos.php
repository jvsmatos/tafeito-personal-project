...
?>
        ...
        <main class="wrapper">
            ...
            <div class="orders-container">
                ...
                <?php
                $pedidos = readOrders($conn, $_SESSION['id']);
                if (empty($pedidos)){
                    echo '<p style="text-align:center">Você ainda não criou nenhum pedido.</p>';
                }else{ 
                    foreach($pedidos as $pedido){ 
                ?>
                    <li>
                        <a href="pedido.php?userid=<?php echo $pedido['usuarioid']; ?>&id=<?php echo $pedido['id']; ?>">
                            <div class="order-id">
                                <span class="order-num">Pedido: <?php echo str_pad($pedido['id'], 4, '0', STR_PAD_LEFT); ?></span>
